var SC: any; // Magic - tells that there is some variable SC out there (SC is from the SoundCloud script file)
...
refreshbtn.addEventListener("click", function () {
    ...
    // Load random song based on mood
    loadSong(currentMood);
    //Erase this because we dont need below code
...
var myClientId = "46848b5036890e23d2ea5604e06b9568";
